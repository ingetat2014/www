...
/**
 * Missionaffretement
 * @UniqueEntity("numexpedition",  message ="Ce num. expedition existe déja.Veuillez choisir un autre")
 * @UniqueEntity("bonlivraison",  message ="Ce bon de livraison existe déja.Veuillez choisir un autre")
...
class MissionAffretement {
    ...
    /**
     * @ORM\OneToOne(targetEntity="FeuilleDeRoute",mappedBy="missionAffretement")
     * @ORM\JoinColumn(nullable=true,onDelete="SET NULL")
     */
    private $feuilleDeRoute; //persist

    /**
     * @ORM\ManyToOne(targetEntity="Fdr\UserBundle\Entity\User", inversedBy="missionAffretements")
     *  @ORM\JoinColumn(nullable=true,onDelete="SET NULL")
     */
    private $user;

    /**
     * @ORM\OneToMany(targetEntity="Modification",mappedBy="missionAffretement")
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="dateGeneree", type="datetime", nullable=false)
     */
    private $dateGeneree;
    ...
    /**
     * @var string
     * @Assert\Type(type="string", message="La valeur du champs n'est pas {type}.")
     ...
     * @var string
     *
     * @ORM\Column(name="clientDestinataire", type="string", length=100, nullable=false)
     */
    ...
    /**
     * @var string
     * @Assert\Regex(pattern="/(0|[1-9]{1,3}0)[0-9]{9}/",htmlPattern = "^(0|[1-9]{1,3}0)[0-9]{9}$",match=true,message="Fomat Tel. non valide")
     * @ORM\Column(name="telresponsable", type="string", length=15, nullable=true)
     */
     ...
     * @ORM\Column(name="montantfacture", type="float", precision=15, scale=2, nullable=true)
     */
    ...
    /**
     *
     * @ORM\Column(name="typeVehicule", type="string", nullable=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="nombreManutentionVoulu", type="integer", nullable=true)
     */
    private $nombreManutentionVoulu;
    ...
    /**
     * Set nombreManutentionVoulu
     *
     * @param integer $nombreManutentionVoulu
     * @return MissionAffretement
     */
    public function setNombreManutentionVoulu($nombreManutentionVoulu) {
        $this->nombreManutentionVoulu = $nombreManutentionVoulu;

        return $this;
    }

    /**
     * Get nombreManutentionVoulu
     *
     * @return integer 
     */
    public function getNombreManutentionVoulu() {
        return $this->nombreManutentionVoulu;
    }
