...
class ManutentionnaireController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        $entities = $em->getRepository('FdrAdminBundle:Manutentionnaire')->findBy(array(), array('id' => 'DESC'));
    ...
    public function rechercheAction(Request $request) {
        ...
        if ($search_form->isValid()) {
            ...
            $em = $this->getDoctrine()->getManager();
            $query = $em->createQuery('SELECT p FROM FdrAdminBundle:Manutentionnaire p WHERE p.' . $par . ' like :keyword ORDER BY p.' . $par . ' ASC')
        ...
        //--
        return $this->render('FdrAdminBundle:Manutentionnaire:recherche.html.twig', array(
                    'entities' => $entities,
                    'form' => $form,
                    'search_form' => $search_form->createView(),
                    'keyword' => $keyword,
    ...
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            $em->persist($entity);
            $em->flush();
            $this->get('session')->getFlashBag()->add('accuseAjout', 'Manutentionnaire ayant id=' . $entity->getId() . ' a bien été ajouté');
    ...
    public function showAction($id) {
        ...
        if (!$entity) {
            $this->get('session')->getFlashBag()->add('notFoundException', 'Impossible de trouver manutentionnaire ayant code=' . $id);
            return $this->redirect($this->generateUrl('manutentionnaire'));
        }
    ...
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            $em->flush();
            $this->get('session')->getFlashBag()->add('accuseModification', 'Manutentionnaire ayant id=' . $entity->getId() . ' a bien été modifié');
    ...
    public function deleteAction(Request $request, $id) {
        ...
        if ($form->isValid()) {
            ...
            $em->remove($entity);
            $em->flush();
            $this->get('session')->getFlashBag()->add('accuseSuppression', 'Manutentionnaire ayant id=' . $entity->getId() . ' a bien été supprimé');
        }
    ...
    private function createSearchForm() {
        return $this->createFormBuilder()
                        ->setAction($this->generateUrl('manutentionnaire_recherche', array()))
                        ->setMethod('GET')
                        //--
