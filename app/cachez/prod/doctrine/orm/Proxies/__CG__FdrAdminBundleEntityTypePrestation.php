...
class TypePrestation extends \Fdr\AdminBundle\Entity\TypePrestation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fdr\\AdminBundle\\Entity\\TypePrestation' . "\0" . 'secteurs', '' . "\0" . 'Fdr\\AdminBundle\\Entity\\TypePrestation' . "\0" . 'feuilleDeRoutes', '' . "\0" . 'Fdr\\AdminBundle\\Entity\\TypePrestation' . "\0" . 'id', '' . "\0" . 'Fdr\\AdminBundle\\Entity\\TypePrestation' . "\0" . 'libelle');
        }
