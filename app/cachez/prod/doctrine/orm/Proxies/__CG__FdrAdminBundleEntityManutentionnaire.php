 ...
 */
class Manutentionnaire extends \Fdr\AdminBundle\Entity\Manutentionnaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Manutentionnaire $proxy) {
