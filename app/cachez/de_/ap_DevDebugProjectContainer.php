...
class ap_DevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'entitie_manager' => 'getEntitieManagerService',
            'fdr_user.registration.form.type' => 'getFdrUser_Registration_Form_TypeService',
            ...
            'kernel.listener.redirectlistener' => 'getKernel_Listener_RedirectlistenerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'kernel.listener.redirectlistener', 1 => 'onKernelException'), 0);
        $instance->addListenerService('kernel.request', array(0 => 'kernel.listener.redirectlistener', 1 => 'onKernelRequest'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'feuillederoute', 'user' => 'ctm-messagerie', 'password' => 'myAdmin@ctm-Komay2015', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Fdr\\AdminBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Fdr\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Fdr\\AdminBundle\\Entity');
        $c->addDriver($b, 'Fdr\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('FdrAdminBundle' => 'Fdr\\AdminBundle\\Entity', 'FdrUserBundle' => 'Fdr\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d0ede17a02999a890a9b79eb386e5e6b75c8960007f60b66ead1ee4512053c44');
    ...
    /**
     * Gets the 'entitie_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fdr\AdminBundle\Services\Enmanager A Fdr\AdminBundle\Services\Enmanager instance.
     */
    protected function getEntitieManagerService()
    {
        return $this->services['entitie_manager'] = new \Fdr\AdminBundle\Services\Enmanager($this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'fdr_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fdr\UserBundle\Form\Type\RegistrationFormType A Fdr\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getFdrUser_Registration_Form_TypeService()
    {
        return $this->services['fdr_user.registration.form.type'] = new \Fdr\UserBundle\Form\Type\RegistrationFormType('Fdr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Fdr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Fdr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'fdr_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Fdr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Fdr\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Fdr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['html2pdf_factory'] = new \Ensepar\Html2pdfBundle\Factory\Html2pdfFactory('P', 'A4', 'fr', true, 'UTF-8', array(0 => 15, 1 => 20, 2 => 15, 3 => 20));
    }
    ...
    /**
     * Gets the 'kernel.listener.redirectlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fdr\AdminBundle\EventListener\HookListener A Fdr\AdminBundle\EventListener\HookListener instance.
     */
    protected function getKernel_Listener_RedirectlistenerService()
    {
        return $this->services['kernel.listener.redirectlistener'] = new \Fdr\AdminBundle\EventListener\HookListener($this, $this->get('session'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Fdr\AdminBundle\Mailer\Mailer A Fdr\AdminBundle\Mailer\Mailer instance.
     */
    protected function getMyMailerService()
    {
        return $this->services['my_mailer'] = new \Fdr\AdminBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/feuillederoute/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/depot/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/filiale/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/secteur/');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/typeprestation/');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/chauffeur/');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/vehicule/');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/manutentionnaire/');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/missionaffretement/');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/role/');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ville/');

        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('^/typeconsommation/');

        $z = new \Symfony\Component\Security\Http\AccessMap();
        $z->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($i, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $z->add($j, array(0 => 'ROLE_ADMIN'), NULL);
        $z->add($k, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($l, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($m, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($n, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($o, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($p, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($q, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($r, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($s, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($t, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($u, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($v, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($p, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($w, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($x, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($y, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $z->add($w, array(0 => 'ROLE_ADMIN'), NULL);

        $aa = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $ba = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $aa, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($aa, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $ba->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $ca = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($aa, array());
        $ca->setOptions(array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $ca->setProviderKey('main');

        $da = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $aa, array(), $a);
        $da->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($z, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $ba, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $aa, 'main', $ca, $da, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '559287d6686d1', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $z, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $aa, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $aa, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('webartcom.ismail@gmail.com');
        $a->setPassword('webartcomKomayO2014');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Fdr\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Fdr\\UserBundle/Resources/views'), 'FdrUser');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FdrUserBundle' => 'Fdr\\UserBundle\\FdrUserBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'feuillederoute',
            'database_user' => 'ctm-messagerie',
            'database_password' => 'myAdmin@ctm-Komay2015',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'webartcom.ismail@gmail.com',
            'mailer_password' => 'webartcomKomayO2014',
            'mailer_encryption' => 'ssl',
            'mailer_name' => 'CTM-Messagerie',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'webartcom.ismail@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'webartcomKomayO2014',
            ...
            'fos_user.model.user.class' => 'Fdr\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'fdr_user_registration',
