...
function etat()
{
    ...
    else if ((document.getElementById("form_type").value==="vehicule")||(document.getElementById("form_type").value==="toutes") ||(document.getElementById("form_type").value==="chauffeur")||(document.getElementById("form_type").value==="typeVehicule"))
    {
        $('#form_vehicules').hide(200);$('#form_vehicules').attr('required',false);
        $('#form_chauffeurs').hide(200);$('#form_chauffeurs').attr('required',false);
    }
}
...
function changerAttrSelectedChauffeur(id){

    var res = id.split("_");
    var chaufflst = "#fdr_adminbundle_feuillederoute_manutentions_" + res[res.length - 2] + "_chauffeur";
    $(chaufflst+ ' option[value="'+$(chaufflst).val()+'"]').attr('selected', 'selected');
    $(chaufflst+ ' option[value!="'+$(chaufflst).val()+'"]').attr('selected', false);
   // alert($(chaufflst).val());
}
...
var crudParamEtModif = function(etat) {
    ...
    //Parametrage
    $('#fdr_adminbundle_parametrage_heureDebutDejeuner').datetimepicker({
        format: "H:i",
        timepicker: true,
        datepicker: false,
        step:5
    });
    $('#fdr_adminbundle_parametrage_heureFinDejeuner').datetimepicker({
        format: "H:i",
        timepicker: true,
        datepicker: false,
        step:5
    });
    $('#fdr_adminbundle_parametrage_heureDebutDiner').datetimepicker({
        format: "H:i",
        timepicker: true,
        datepicker: false,
        step:5
    });
    $('#fdr_adminbundle_parametrage_heureFinDiner').datetimepicker({
        format: "H:i",
        timepicker: true,
        datepicker: false,
        step:5
    });
    $('#fdr_adminbundle_parametrage_heureDebutDecoucher').datetimepicker({
        format: "H:i",
        timepicker: true,
        datepicker: false,
        step:5
    });
    $('#fdr_adminbundle_parametrage_heureFinDecoucher').datetimepicker({
        format: "H:i",
        timepicker: true,
        datepicker: false,
        step:5
